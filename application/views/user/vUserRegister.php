        ...
        <table id="tblRegisterForm">
            ...
            <tr>
                ...
                <td class="RegFormField">
                    ...
                    <span class="spnNotCorrect" id="spnLicense">Вы ввели запрещенные символы!</span>
                </td>
                <td class="RegFormFlag">img</td>
            </tr>
            <tr>
                ...
                <td class="RegFormField">
                    <img src="../../../stfile/img/capcha.png" alt="capcha"><input type="text" class="inpColor" id="inpCapcha"><br/>
...
5.1.	Правообладатель гарантирует, что работа Программного продукта будет соответствовать описанию, данному в документации.<br/><br/>
5.2.	Правообладатель не несет никакой ответственности в случае несовместимости Программного продукта с программным обеспечением на Вашем компьютере.<br/><br/>
5.3.	Правообладатель не несет ответственность за какой-либо ущерб, связанный с использованием или невозможностью использования Программного продукта.<br/><br/>
5.4.	Правообладатель не несет никакой ответственности за последствия и ущерб, который может нанести Программный продукт в случае несоблюдения Вами обязанности, указанной в пункте 4.2 настоящего Соглашения.<br/><br/>
5.5.	За нарушение авторских прав на Программный продукт нарушитель несет гражданскую, административную или уголовную ответственность в соответствии с законодательством Российской Федерации.<br/><br/>
</div>
</div>