...
class Kohana_HTMLTest extends Unittest_TestCase
{
	...
	public function provider_style()
	{
		return array(
			array(
				'<link type="text/css" href="http://google.com/style.less" rel="stylesheet" />',
				'http://google.com/style.less',
				array(),
				NULL,
				FALSE
			),
			array(
				'<link type="text/css" href="/kohana/my/style.less" rel="stylesheet" />',
				'my/style.less',
				array(),
				NULL,
				FALSE
			...
			array(
				'<link type="text/css" href="https://www.kohanaframework.org/kohana/my/style.less" rel="stylesheet" />',
				'my/style.less',
				array(),
				'https',
				FALSE
			...
			array(
				'<link type="text/css" href="https://www.kohanaframework.org/kohana/index.php/my/style.less" rel="stylesheet" />',
				'my/style.less',
				array(),
				'https',
				TRUE
